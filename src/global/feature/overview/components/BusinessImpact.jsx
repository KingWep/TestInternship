    ...
    <section id="impact" className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-stretch max-w-5xl mx-auto font-kantumruy">
          {/* Before */}
          <div className="bg-white rounded-3xl p-8 lg:p-10 border border-red-100 shadow-[0_4px_20px_rgba(239,68,68,0.05)]">
          ...
          {/* After */}
          <div className="bg-white rounded-3xl p-8 lg:p-10 border border-emerald-100 shadow-[0_10px_30px_rgba(16,185,129,0.1)] relative overflow-hidden">
