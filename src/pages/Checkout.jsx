  ...
  const handleOrder = async () => {
    ...
    if (!customerName || !phone || !address) {
      await Swal.fire({
        ...
        text: "សូមបំពេញឈ្មោះ លេខទូរស័ព្ទ និងអាសយដ្ឋាន",
        confirmButtonText: "យល់ព្រម",
        confirmButtonColor: "#7f1d1d",
      })
    ...
    const result = await Swal.fire({
        ...
        text: "តើអ្នកចង់បោះពុម្ពវិក្កយបត្រទេ?",
        showCancelButton: true,

        confirmButtonText: "🖨️ Print Receipt",
        cancelButtonText: "មិនទេ",
    ...
    return (
      <div className="min-h-screen bg-slate-50 flex items-center justify-center px-4">
        ...
        <div className="bg-white rounded-3xl shadow-sm border border-slate-200 p-10 text-center max-w-md w-full">
          <div className="w-16 h-16 mx-auto rounded-full bg-red-50 flex items-center justify-center text-2xl">🛒</div>
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <Link
            to="/"
            className="inline-flex items-center gap-2 text-sm font-medium text-slate-500 hover:text-red-700 transition-colors"
          >
            <ArrowLeft size={17} />
            ត្រឡប់ទៅទំព័រដើម
          </Link>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden">
              ...
              <div className="px-6 py-5 border-b border-slate-100 flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400 mt-0.5">
                    ជ្រើសរើសអ្នកផ្តល់សេវាដឹកជញ្ជូន
                  </p>
                </div>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden">
              <div className="px-6 py-5 border-b border-slate-100 flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400 mt-0.5">
                    ជ្រើសរើសវិធីបង់ប្រាក់ដែលអ្នកពេញចិត្ត
                  </p>
                </div>
              </div>
          ...
          <div className="lg:sticky lg:top-6 space-y-5">
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-5">
              ...
              <p className="text-[11px] text-center text-slate-400 mt-4 leading-relaxed">
                ដោយចុច "បញ្ជាទិញ" អ្នកយល់ព្រមជាមួយ
                លក្ខខណ្ឌនៃការបញ្ជាទិញរបស់យើង
              </p>
            </div>
          </div>
        </div>
